...
from generated.common.ubl_common_basic_components_2_1 import (
...
class AllowanceChargeType:
    ...
    allowance_charge_reason: Optional[AllowanceChargeReason] = field(
        default=None,
        metadata={
...
class DeliveryTermsType:
    ...
    special_terms: Optional[SpecialTerms] = field(
        default=None,
        metadata={
            "name": "SpecialTerms",
            "type": "Element",
...
class TaxCategoryType:
    ...
    tax_exemption_reason: Optional[TaxExemptionReason] = field(
        default=None,
        metadata={
...
class FinancialAccountType:
    ...
    payment_note: Optional[PaymentNote] = field(
        default=None,
        metadata={
            "name": "PaymentNote",
            "type": "Element",
...
class PaymentMeansType:
    ...
    instruction_note: Optional[InstructionNote] = field(
        default=None,
        metadata={
...
class PersonType:
    ...
    identity_document_reference: Optional[IdentityDocumentReference] = field(
        default=None,
        metadata={
...
class ItemType:
    ...
    brand_name: Optional[BrandName] = field(
        default=None,
        metadata={
            "name": "BrandName",
            "type": "Element",
    ...
    manufacturers_item_identification: Optional[ManufacturersItemIdentification] = field(
        default=None,
        metadata={
...
class PartyType:
    ...
    party_name: Optional[PartyName] = field(
        default=None,
        metadata={
            "name": "PartyName",
            "type": "Element",
    ...
    party_tax_scheme: Optional[PartyTaxScheme] = field(
        default=None,
        metadata={
            "name": "PartyTaxScheme",
            "type": "Element",
...
class TransportHandlingUnitType:
    ...
    handling_instructions: Optional[HandlingInstructions] = field(
        default=None,
        metadata={
...
class ReceiptLineType:
    ...
    despatch_line_reference: Optional[DespatchLineReference] = field(
        default=None,
        metadata={
